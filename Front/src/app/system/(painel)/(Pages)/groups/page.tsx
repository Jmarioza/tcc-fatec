...
export default function GroupScreen() {
  ...
  async function fetchAllGroups(id: number) {
    try {
      setIsLoading(true)
      const data = await beneficiaryGroupService.getByAccreditorId(id)
            ...
            onClick={() =>
              openModal(async () => {
                try {
                  ...
                  await fetchAllGroups(Number(accreditor.id))
